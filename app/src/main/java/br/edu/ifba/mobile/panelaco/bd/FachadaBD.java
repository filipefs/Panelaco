...
public class FachadaBD extends SQLiteOpenHelper {
    ...
    private static String COMANDO_CRIACAO_TABELA_NUTRICAO = "CREATE TABLE NUTRICAO(CODIGO INTEGER NOT NULL AUTOINCREMET, " +
            "NUTRIENTES TEXT, CALORIAS INT, COD_RECEITAS INTEGER NOT NULL, FOREIGN KEY(COD_RECEITAS) REFERENCES RECEITAS(CODIGO), PRIMARY KEY (CODIGO, COD_RECEITAS))";
